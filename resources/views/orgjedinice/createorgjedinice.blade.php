...
@section('orgjed')
    <div class="card-body">
        <form method="POST" action="{{ route('storeOrganizacionajedinica') }}">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="vrsta" type="text" class="form-control @error('vrsta') is-invalid @enderror" name="vrsta" value="{{ old('vrsta') }}" required autocomplete="vrsta" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="adresa" type="text" class="form-control @error('adresa') is-invalid @enderror" name="adresa" value="{{ old('adresa') }}"autocomplete="adresa" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="postbr" type="text" class="form-control @error('postbr') is-invalid @enderror" name="postbr" value="{{ old('postbr') }}" autocomplete="postbr" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="mesto" type="text" class="form-control @error('mesto') is-invalid @enderror" name="mesto" value="{{ old('mesto') }}" autocomplete="mesto" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="odglice" type="text" class="form-control @error('odglice') is-invalid @enderror" name="odglice" value="{{ old('odglice') }}" autocomplete="odglice" autofocus>
            ...
            <div class="form-group row mb-0">
                <div class="col-md-8 offset-md-4">
                    <button type="submit" class="btn btn-primary">
                        {{ __('Dodaj organizacionu jedinicu') }}
                    </button>
                </div>
            </div>
        </form>

        ...
        <form method="POST" action="{{$edit ? route('updateFirma',$firma->FirmaID) : route('storeFirma')}}">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="mesto" type="text" class="form-control @error('mesto') is-invalid @enderror" name="mesto" value="{{ $firma->Mesto ?? ""}}" required autocomplete="mesto" autofocus>
                ...
                <div>
                    ...
                    <select id="fiskalni"  class="form-control dropdown" name="fiskalni">
                        ...
                        @foreach($fiskalniStampaci as $stampac)
                            <option value="{{$stampac}}" @if($edit && $stampac==$firma->FiskalniStampac) selected @endif>{{$stampac}}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                    <label for="pdv" class="col-form-label">PDV</label>
                    <input id="pdv" type="checkbox" name="pdv" class="form-control form-check" value="1" @if($edit && $firma->PDV) checked @endif>
                </div>
                <hr>
                <br>

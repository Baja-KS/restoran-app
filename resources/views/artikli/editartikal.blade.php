...
@section('content')
    ...
    <div class="container-fluid">
        <form action="{{route('updateArtikal',$artikal->PLUKod)}}" method="POST">
            @csrf
            @method('PATCH')
            <h2 class="text-light">Izmeni artikal</h2>
            <hr>
            <div class="container-fluid" style="background-color: saddlebrown !important;">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div>
                            <label for="prodavnica" class="col-form-label text-light">Prodavnica*</label>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <div>
                            <label for="kolicinaulaza" class="col-form-label text-light">Kolicina Ulaza</label>
                        ...
                        <div>
                            <label for="kolicinaizlaza" class="col-form-label text-light">Kolicina Izlaza</label>
                        ...
                        <div>
                            <label for="zadnjaprodajnacena" class="col-form-label text-light">Zadnja Prodajna Cena</label>
                        ...
                        <div>
                            <label for="zadnjanabavnacena" class="col-form-label text-light">Zadnja Nabavna Cena</label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <table class="table table-borderless" id="tabelakomponenti">
                            <thead>
                            <tr>
                                <th text-light>Naziv komponente</th>
                                <th text-light>Kolicina</th>

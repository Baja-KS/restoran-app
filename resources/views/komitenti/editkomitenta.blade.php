            ...
            <div class="col-md-2">
                <div class="form-group">
                    <div>
                        ...
                        <input id="pdv" type="checkbox" name="pdv" class="form-control form-check" value="true" @if($komitent->PDV) checked @endif>
                    </div>
                    <div>
                        <label for="dobavljac" class="col-form-label">Dobavljac</label>
                        <input id="dobavljac" type="checkbox" name="dobavljac" class="form-control form-check " value="true" @if($komitent->Dobavljac) checked @endif>
                        <label for="kupac" class=" col-form-label">Kupac</label>
                        <input id="kupac" type="checkbox" name="kupac" class="form-control form-check" value="true" @if($komitent->Kupac) checked @endif>
                    </div>
                    <div>
                        <label for="inostrani" class=" col-form-label">Inostrani</label>
                        <input id="inostrani" type="checkbox" name="inostrani" class="form-control form-check" value="true" @if($komitent->Inostrani) checked @endif>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <div id="drzavaWrapper" style="display: none">
                        ...
                        <input id="drzava" type="text" name="drzava" class="form-control @error('drzava') is-invalid @enderror" @if($komitent->Inostrani) value="{{$komitent->Drzava}}" @endif>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-success">Azuriraj komitenta</button>
